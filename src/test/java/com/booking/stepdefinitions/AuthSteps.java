...
public class AuthSteps {
    ...
    public void theUserProvidesUsernameAndPassword(String username, String password) {
    ...
    public void theErrorMessageContains(String expectedMessage) {
        String actualResponse = testContext.getResponse().asString();
